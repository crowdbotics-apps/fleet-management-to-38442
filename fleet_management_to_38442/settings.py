"""
Django settings for fleet_management_to_38442 project.
...
ROOT_URLCONF = 'fleet_management_to_38442.urls'
...
WSGI_APPLICATION = 'fleet_management_to_38442.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fleet_management_to_38442 API",
    "DESCRIPTION": "API documentation for fleet_management_to_38442 App",
    "VERSION": "v1",
}
