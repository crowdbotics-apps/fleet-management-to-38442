...
## Project Structure
    ...
    ├── fleet_management_to_38442  # Django project configurations
...
1. Clone this repo and `cd fleet_management_to_38442`
...
2. Clone this repo and `cd fleet_management_to_38442`
